...
# -------------------------------------------------------------------
# 2. Data loader functions (sebelumnya di src/data_loader.py)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 3. Aggregator functions (sebelumnya di src/aggregator.py)
# -------------------------------------------------------------------
...
# -------------------------------------------------------------------
# 4. User state (sebelumnya di src/user_state.py)
# -------------------------------------------------------------------
